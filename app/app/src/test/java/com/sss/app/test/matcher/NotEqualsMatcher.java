...
public class NotEqualsMatcher<T, R> extends BaseMatcher<T> {
    private final Function<T, R> actualValueSupplier;
    private final R expectedValue;
    private String fieldName;

    public NotEqualsMatcher(Function<T, R> actualValueSupplier, R expectedValue) {
        this.actualValueSupplier = actualValueSupplier;
        this.expectedValue = expectedValue;
    }

    public NotEqualsMatcher(Function<T, R> actualValueSupplier, R expectedValue, String fieldName) {
        this.actualValueSupplier = actualValueSupplier;
        this.expectedValue = expectedValue;
    ...
    public void matches(T matchingObject) {
        assertNotEquals(expectedValue, actualValueSupplier.apply(matchingObject), getFailMessage());
    }
